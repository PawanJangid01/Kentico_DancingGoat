...
builder.Logging.AddFilter("CMS", LogLevel.Debug);
builder.Logging.AddFilter("CMS.ContentSynchronization", LogLevel.Debug);
builder.Logging.AddFilter("CMS.ContentEngine", LogLevel.Debug);
builder.Logging.AddFilter("CMS.Websites", LogLevel.Debug);
...
builder.Services.Configure<ContentSynchronizationOptions>(options =>
{
    ...
    options.Source.Secret = "20814845687781979855245877890030";
    // exactly 32 characters
    // this MUST match the Test project

    options.Source.TargetUrl = "http://localhost:16767/";
});
